            ...
            <div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
                <div class="row">
                    <div class="col-lg-8 cp-r animate-box">
                        <textarea class="form form-control" id="note_content" style="width: 100%; height: 400px" disabled="disabled"></textarea>

                    </div>
                    <div class="col-lg-4 animate-box">
                        <div class="fh5co-highlight right">
                            <button class="btn btn-info btn-block mb-2" type="submit" onclick="update()" id="updateBtn">Update</button>
                            <button class="btn btn-danger btn-block" type="submit" onclick="openModel()">Delete</button>
                        </div>
                    </div>
                </div>
